      ...
      <div class="white-bg">
        ...
        <div class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-md-5">
              <router-link to="/api/template/信用评估【详细版】.xlsx" target="_blank" class="el-button el-button--danger">下载模版</router-link>
  ...
  export default{
    ...
    methods: {
      ...
      searchResult(){
        ...
        _this.$store.dispatch("ASSESS_DETAILS_BATCH",{ param }).then((res,req)=>{
          if(res.success){
