  ...
  <div>
    <div class="container">
      <div class="white-bg">
        ...
        <h2 class="text-center">类型：精准营销</h2>
        <div class="form-horizontal">
          <div class="form-group">
            <label class="col-md-4 control-label">请下载模版：</label>
            <div class="col-md-5">
              <router-link to="/api/template/精准营销.xlsx" target="_blank" class="el-button el-button--danger">下载模版</router-link>
  ...
  export default{
    ...
    methods: {
      ...
      searchResult(){
        ...
        _this.$store.dispatch("MARKETING_BATCH",{ param }).then((res,req)=>{
          if(res.success){
