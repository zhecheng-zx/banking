        ...
        <div class="block">
          ...
          <div class="box">
            <el-form ref="form" :model="form" :rules="rules1" label-width="138px">
              ...
              <el-form-item label="邮箱：" prop="newel">
              ...
              <el-form-item label="验证码：" prop="emailCode">
                ...
                <el-col :span="8">
                  <el-button size="large" @click="sendSMS()" :disabled="disabled1">发送验证码</el-button>
                </el-col>
              </el-form-item>
  ...
  export default{
    ...
    methods: {
      ...
      confirm(formName){
        ...
        _this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            _this.$store.dispatch("EMAIL_BIND",{ param }).then((res)=>{
              if(res.success){
      ...
      sendSMS(){
        ...
        if(!_this.form.beforepw||_this.form.beforepw.length<6||_this.form.beforepw.length>16||!param.newml||!_this.form.vcode||_this.form.vcode.length!=4){
        ...
        _this.$store.dispatch("EMAIL_SEND",{ param }).then((res)=>{
          console.log(res)
        })
      },
    },
