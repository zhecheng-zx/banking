  ...
  <div>
    <div class="container">
      <div class="white-bg">
        ...
        <h2 class="text-center">类型：反欺诈（标准版）</h2>
        <div class="form-horizontal">
          <div class="form-group">
            <label class="col-md-4 control-label">请下载模版：</label>
            <div class="col-md-5">
              <router-link to="/api/template/反欺诈【标准版】.xlsx" target="_blank" class="el-button el-button--danger">下载模版</router-link>
  ...
  export default{
    ...
    methods: {
      ...
      searchResult(){
        ...
        _this.$store.dispatch("ANTIFRAUD_BQUERYONE",{ param }).then((res,req)=>{
          if(res.success){
