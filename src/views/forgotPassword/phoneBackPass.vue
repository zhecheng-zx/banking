            ...
            <div v-if="step==1" class="box">
              <el-form ref="form" :model="form" :rules="rules1" label-width="120px">
                <el-form-item label="手机号码：" prop="mobile">
                  <el-input v-model="form.mobile" size="larger"></el-input>
                </el-form-item>
                ...
                <el-form-item label="短信验证码：" prop="smsCode">
                  <el-col :span="15">
                    <el-input v-model="form.smsCode" size="larger"></el-input>
                  </el-col>
            ...
            <div v-if="step==2" class="box">
              <el-form ref="form2" :model="form2" :rules="rules2" label-width="140px">
                <el-form-item label="新登录密码：" prop="pw1">
                  <el-input v-model="form2.pw1" type="password" size="larger" auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item label="确认新登录密码：" prop="pw2">
                  <el-input v-model="form2.pw2" type="password" size="larger" auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item label=" ">
  ...
  export default{
    ...
    methods: {
      ...
      send(){
        ...
        _this.$store.dispatch("PHONE_SENDBACK",{ param }).then((res)=>{
          _this.$notify({
            title: '提示',
      ...
      step1(){
        ...
        _this.$store.dispatch("PHONE_STEPBACK1",{ param }).then((res)=>{
          if(res.success){
            _this.form2.mobile = param.mobile
            _this.step = 2
            clearInterval(_this.timer)
            _this.timer1=180
            _this.disabled1= false
      ...
      step2(){
        ...
        _this.$store.dispatch("PHONE_STEPBACK2",{ param }).then((res)=>{
          if(res.success){
            _this.step = 3
          }else{
            _this.step = 1
